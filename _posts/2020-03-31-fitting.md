...
\medskip
Consider a set of $m=9$ measurements: $28, 62, 80, 84, 86, 86, 92, 95,
98$. A
way to summarize these data is by their mean
$$
...
![trends]({{ "/assets/trends.png" | absolute_url }}){: .center-image }
...
&I_i=\frac{\betaI^{\alpha}_{i-1}S_{i-1}}{N} & & \forall i \in SI\setminus\{1\}\\
...
multiple local minima may ex- ist (due to the shape of the objective
